...
| Problem | Solution |
|---------|----------|
| Don't know how to test | Write wished-for API. Write assertion first. Use the appropriate tool for asking the user a question or requesting input to check with your human partner. |
...
When adding mocks or test utilities, refer to the [## Testing Anti-Patterns Reference](#testing-anti-patterns-reference) appendix below to avoid common pitfalls:
...
No exceptions without your human partner's permission. Use the appropriate tool for asking the user a question or requesting input if you need to check.
